export const PHONE_DISPLAY = "+7 (978) 889-89-29"
export const PHONE_DIGITS = "79788898929"
...
export const WHATSAPP_PHONE_DIGITS = "79788898929"
export const WHATSAPP_URL = `https://wa.me/${WHATSAPP_PHONE_DIGITS}?text=${encodeURIComponent(BOOKING_MESSAGE)}`
